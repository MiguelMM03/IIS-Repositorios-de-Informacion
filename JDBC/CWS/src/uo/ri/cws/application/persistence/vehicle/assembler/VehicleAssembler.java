...
public class VehicleAssembler {
    ...
    public static List<VehicleDALDto> toVehicleDALDtoList(ResultSet rs)
	    throws SQLException {
    ...
    public static Optional<VehicleDALDto> toVehicleDALDto(ResultSet rs)
	    throws SQLException {
    ...
    private static VehicleDALDto resultSetToVehicleDALDto(ResultSet rs)
	    throws SQLException {
	...
	record.vehicleTypeId = rs.getString("vehicletype_id");
