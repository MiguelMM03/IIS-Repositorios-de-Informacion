...
public class MechanicAssembler {
	...
	public static Optional<MechanicDALDto> toMechanicDALDto(ResultSet m)
			throws SQLException {
		if (m.next()) {
	...
	public static List<MechanicDALDto> toMechanicDALDtoList(ResultSet rs)
			throws SQLException {
	...
	private static MechanicDALDto resultSetToMechanicDALDto(ResultSet rs)
			throws SQLException {
