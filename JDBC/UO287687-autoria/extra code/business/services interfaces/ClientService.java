...
public interface ClientService {
     ...
     *                                  with the same dni
     */
    ClientBLDto addClient(ClientBLDto client, String recommenderId)
     ...
     */
    Optional<ClientBLDto> findClientById(String idClient)
	    throws BusinessException;
     ...
     *                                  DOES NOT throw BusinessException
     */
    List<ClientBLDto> findClientsRecommendedBy(String sponsorID)
	    throws BusinessException;
