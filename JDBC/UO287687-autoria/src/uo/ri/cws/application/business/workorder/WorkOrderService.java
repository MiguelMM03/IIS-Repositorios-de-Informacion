...
public interface WorkOrderService {
	 ...
	 *
	 * @throws IllegalArgumentException if the argument is null, or the vehicle id
	 *                                  or description are null or empty Strings
	 *                                  BusinessException if: - there is another
	 *                                  work order for the same vehicle at the same
	 *                                  date and time (timestamp), or - the vehicle
	 *                                  does not exist
	 */
	WorkOrderBLDto registerNew(WorkOrderBLDto dto) throws BusinessException;
	 ...
	 * @throws IllegalArgumentException if the argument is null, or the vehicle id
	 *                                  or description are null or empty Strings
	 *                                  BusinessException if: - there is no work
	 *                                  order with that id, or - [JPA] there work
	 *                                  order has not the specified version
	 *                                  (optimistic lock), or - the work order is
	 *                                  not in the OPEN or ASSIGNED status
	 */
	 ...
	 *                                  BusinessException if: - the work order does
	 *                                  not exist, or - there already is some
	 ...
	 */
	Optional<WorkOrderBLDto> findWorkOrderById(String woId) throws BusinessException;

	/**
	 * @return a list of all work orders either in the OPEN or ASSIGN status
	 * @throws BusinessException, DOES NOT
	 */
	List<WorkOrderBLDto> findUnfinishedWorkOrders() throws BusinessException;
	 ...
	 * @throws BusinessException,       DOES NOT
	 */
	List<WorkOrderBLDto> findWorkOrdersByPlateNumber(String plate) throws BusinessException;
	 ...
	 * @param mechanicDNI, the DNI of the mechanic to be assigned
	 * @throws IllegalArgumentException if any argument is null or empty
	 * @throws BusinessException        if:if: - the mechanic does not exist,or -
	 *                                  the work order is not in OPEN status, or -
	 *                                  the mechanic has no certification for the
	 *                                  vehicle type
	 */
	void assignWorkOrderToMechanic(String woID, String mechanicDni) throws BusinessException;
