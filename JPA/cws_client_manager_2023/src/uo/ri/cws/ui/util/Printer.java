...
public class Printer {
	...
	public static void printTrainingForMechanic(TrainingForMechanicReportLineDto row) {
	...
	public static void printTrainingHoursRow(TrainingForVehicleTypeReportLineDto r) {
